  ...
  return (
          <nav className='w-full flex justify-between items-center h-[86px]'>
              ...
              <div className='sm:flex hidden'>
                  <ul className='list-none flex flex-1 py-[31px] text-greenGrow font-medium text-16px leading-6'>
                      {navLinks.map((nav, index) => (
                          <li key={nav.id} className={`${index === navLinks.length - 1 ? 'mr-[75px]' : 'mr-[40px]'}`}>
